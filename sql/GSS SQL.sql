...
SET C_SORT_1 = 'ENERGY'
WHERE REC = '2' AND CUSTOMER IN ('C37408', 'L12015', 'H84405', 'U15551')

-- SEE MOST RECENT TRANSACTIONS FOR BLANK SORT CODE
SELECT *
FROM "CUSTOMER_SALES"
WHERE REC = '2'
  AND C_SORT_1 = ''
...
SELECT "CUSTOMER_MASTER".NAME_CUSTOMER, "CUSTOMER_SALES".* 
FROM "CUSTOMER_SALES"
JOIN "CUSTOMER_MASTER" ON "CUSTOMER_SALES".CUSTOMER = "CUSTOMER_MASTER".CUSTOMER
WHERE "CUSTOMER_SALES".REC = '2'
  AND "CUSTOMER_SALES".C_SORT_1 = ''
ORDER BY CONCAT(SUBSTRING("CUSTOMER_SALES".DATE_LAST_SALE, 5, 2), SUBSTRING("CUSTOMER_SALES".DATE_LAST_SALE, 1, 4)) DESC

-- CLEAN UP BAD DATES FOR OTD DASHBOARD
SELECT 
--*
ORDER_NO, DATE_ORDER, DATE_DUE, DATE_SHIPPED, DATE_INVOICE
FROM ORDER_HIST_LINE
WHERE ABS(DATEDIFF(DAY, DATE_DUE, DATE_SHIPPED)) > 200
order by DATE_ORDER DEsc
--ORDER BY ABS(DATEDIFF(DAY, DATE_DUE, DATE_SHIPPED)) DESC
